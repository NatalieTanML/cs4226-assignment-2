...
class Topology(Topo):
    def build(self):
        # Add the routers and configure their loopback addresses[^1^][1]
        ...
        h211 = self.addHost('h211', ip='10.2.1.1/24')
        h311 = self.addHost('h311', ip='10.3.1.1/24')
        h411 = self.addHost('h411', ip='10.4.1.1/25')
        h412 = self.addHost('h412', ip='10.4.1.129/25')

        # Add the links between the nodes and assign the interface IP addresses
